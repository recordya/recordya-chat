                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background:#ffffff; border:1px solid #e5e5e5; border-radius:12px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:24px 32px 0; text-align:center;">
                            <h1 style="margin:0; font-size:22px; font-weight:600; color:#0a0a0a; letter-spacing:-0.025em;">${msg("rdyPasswordResetTitle")}</h1>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
                        <td style="padding:16px 32px 0; font-size:14px; line-height:1.6; color:#737373;">
                            ...
                            <p style="margin:12px 0 0;">${msg("rdyPasswordResetLine1Html")}</p>
                        </td>
                    </tr>
                    <!-- CTA Button -->
                    <tr>
                        <td style="padding:24px 32px;" align="center">
                            <a href="${link}" target="_blank" style="display:inline-block; padding:12px 32px; background:#171717; color:#fafafa; font-size:14px; font-weight:500; text-decoration:none; border-radius:10px;">${msg("rdyPasswordResetButton")}</a>
                        </td>
                    </tr>
                    <!-- Expiration notice -->
                    <tr>
                    ...
                    <!-- Ignore notice -->
                    <tr>
                        <td style="padding:16px 32px 0; font-size:13px; line-height:1.5; color:#a3a3a3;">
                            <p style="margin:0;">${msg("rdyPasswordResetIgnoreHtml")}</p>
                        </td>
                    </tr>
                    <!-- Fallback link -->
                    <tr>
