...
<head>
    ...
    <title>${msg("rdyErrorPageTitle")}</title>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">${msg("rdyErrorTitle")}</h1>
                <p class="card-description">${msg("rdyErrorDescription")}</p>
            </div>
            ...
            <div class="card-footer">
                ...
                <#elseif url?? && url.loginUrl?has_content>
                    <a class="btn" href="${url.loginUrl}">${msg("rdyBackToLogin")}</a>
                </#if>
            </div>
        </div>
