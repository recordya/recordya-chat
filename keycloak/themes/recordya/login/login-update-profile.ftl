...
<head>
    ...
    <title>${msg("rdyUpdateProfileTitle")}</title>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">${msg("rdyUpdateProfileTitle")}</h1>
                <p class="card-description">${msg("rdyUpdateProfileDescription")}</p>
            </div>
            ...
            <form class="card-content" action="${url.loginAction}" method="post">
                <div class="field">
                    <label for="email">${msg("rdyEmailLabel")}</label>
                    <input id="email" name="email" type="email"
                           value="${(user.email!'')}"
                           autofocus autocomplete="email" />
                </div>
                <div class="field">
                    <label for="firstName">${msg("rdyFirstNameLabel")}</label>
                    <input id="firstName" name="firstName" type="text"
                           value="${(user.firstName!'')}"
                           autocomplete="given-name" />
                </div>
                <div class="field">
                    <label for="lastName">${msg("rdyLastNameLabel")}</label>
                    <input id="lastName" name="lastName" type="text"
                           value="${(user.lastName!'')}"
                           autocomplete="family-name" />
                </div>
                <div class="card-footer">
                    <button class="btn" type="submit">${msg("rdySubmit")}</button>
                </div>
            </form>
        </div>
